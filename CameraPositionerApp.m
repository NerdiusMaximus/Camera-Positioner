classdef CameraPositionerApp < handle
%
% Usage:
%     app.CameraPositionerApp

  properties
      AppPath = {'/CameraPositioner'};
	  AppClass = 'CameraPositionerApp';
	  AppHandle;
	  AppCount = 0;
      Increment = 1;
	  Decrement = 0;
  ...
  methods
    ...
    function obj = CameraPositionerApp()      
    ...
    function startApp(obj)
        ...
        if nargout(@CameraPositionerGui) == 0  
            eval('CameraPositionerGui');
        else
			obj.AppHandle = eval('CameraPositionerGui');   
        end 
        % Increment the reference count by one    
        CameraPositionerApp.refcount(obj.Increment);
